...
$(function () {
  ...
  if (dt_basic_table.length) {
    var dt_basic = dt_basic_table.DataTable({
      ajax: assetPath + "data/subscription-data.json",
      columns: [
      ...
      columnDefs: [
        {
          ...
          render: function (data, type, full, meta) {
            return `
            <div class="num-badge">
              <span class="num-badge-data">${data}L.E</span>
            </div>
            `;
          },
        },
        ...
        },
        {
          ...
          targets: 4,
          render: function (data, type, full, meta) {
            var $status_number = full["subscription_status"];
            var $status = {
              1: { title: "شهرى", class: "info" },
              2: { title: "ربع سنوى", class: "info" },
              3: { title: "سنوى", class: "info" },
            };
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            var $user_img = full["avatar"],
              $name = full["subscription_name"],
              $post = full["subscription_id"];
            if ($user_img) {
              // For Avatar image
              var $output =
                '<img src="' +
              ...
              // For Avatar badge
              var stateNum = full["subscription_status"];
              var states = ["info"];
