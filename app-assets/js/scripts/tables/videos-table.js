            ...
            return `
              <div class="form-group form-group-inline">
                  <div class="custom-control custom-switch custom-switch-primary">
                      <input type="checkbox" class="custom-control-input" id="visibilty${full["id"]}" ${full["visibility"]} />
                      <label class="custom-control-label" for="visibilty${full["id"]}">
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return `
              <div class="form-group form-group-inline">
                  <div class="custom-control custom-switch custom-switch-primary">
                      <input type="checkbox" class="custom-control-input" id="freeTrial${full["id"]}" ${full["free"]} />
                      <label class="custom-control-label" for="freeTrial${full["id"]}">
                          <span class="switch-icon-left"><i data-feather="check"></i></span>
                          <span class="switch-icon-right"><i data-feather="x"></i></span>
                      </label>
                  </div>
          ...
          render: function (data, type, full, meta) {
            ...
            if ($user_img) {
              ...
              var $output =
                ...
                "images/avatars/" +
                $user_img +
                '" alt="Avatar" width="75" height="50" style="object-fit: cover; border-radius: 12px" />';
            } else {
              // For Avatar badge
